...
import { mainContent, sidebar } from "C:/MxProjects/WidgetDevelopment/showMoreShowLess/test/deployment/native/layouts/Atlas_Core.NativePhone_TopBarOnly.js";
        ...
        content={[
            <$DataView key="p4.NativeMobile.Login.dataView2"
                ...
                object={NanoflowObjectProperty({
                    "dataSourceId": "p4.4",
                    "editable": true,
                    "source": { "nanoflow": () => require("C:/MxProjects/WidgetDevelopment/showMoreShowLess/test/deployment/native/nanoflows/NativeMobile.DSS_CreateLoginContext").DSS_CreateLoginContext },
                    "argMap": {}
                })}
                content={[
                    ...
                    <$Button key="p4.NativeMobile.Login.actionButton2"
                        ...
                        onClick={ActionProperty({
                            "action": { "type": "callNanoflow", "argMap": { "Login": { "widget": "p4.NativeMobile.Login.dataView2", "source": "object" } }, "config": { "nanoflow": () => require("C:/MxProjects/WidgetDevelopment/showMoreShowLess/test/deployment/native/nanoflows/NativeMobile.ACT_SignInUser").ACT_SignInUser }, "disabledDuringExecution": false }
                        })}
                        accessible={false} />,
